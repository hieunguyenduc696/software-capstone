...
export const PostTest = () => {
    ...
    return <div>
        <AppHeader />
        <div>
            <Row style={{ padding: '1.5rem 0 .5rem 1.5rem', backgroundColor: 'white' }}>
                {/* left */}
                <Col span={16} >
                    {/* title */}
                    <div style={{ display: 'flex', alignItems: 'center', gap: 5 }}>
                        ...
                        <div style={{ flexGrow: 1 }}>
                            ...
                            <Row style={{ gap: 5 }}>
                                <Col span={14}>
                                    <input type="text" required ref={titleRef} style={{ fontSize: '24px', lineHeight: '.8', width: '100%', ...(err.title && { borderBottom: '1px solid black' }), }} className={styles['ip-title']}
                                        value={title}
                ...
                {/* right */}
                <Col span={8} style={{ backgroundColor: '#F2F2F2', padding: '1rem', borderRadius: '10px 0 0 10px' }}>
                    <div style={{
                        textTransform: 'uppercase',
                        color: '#81041F',
                        fontSize: '20px',
                    ...
                    <div>
                        {mockPreviewTestItems.map((item, i) => <div style={{ paddingTop: '.5rem' }}><PreviewTestItem item={item} /></div>)}
                    </div>
                </Col>
            </Row>
        </div>
